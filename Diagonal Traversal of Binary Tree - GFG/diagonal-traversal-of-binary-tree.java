...
class Tree
{
     public ArrayList<Integer> diagonal(Node root)
      ...
      public void traveller(Node root , ArrayList<ArrayList<Integer>> list , int level){
          if(root == null)return ;
          if(list.size() < level)list.add(new ArrayList<>()) ;
          list.get(level-1).add(root.data);
          
          traveller(root.left ,list , level+1);
          
          traveller(root.right , list , level);
      }
}
